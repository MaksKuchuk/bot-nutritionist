...
pub async fn start(bot: Bot, dialogue: MyDialogue, msg: Message) -> HandlerResult {
    bot.send_message(msg.chat.id, "Бот-диетолог поможет вам определить суточную норму БЖУ основываясь на ваших физических данных и целях, которые вы преследуете. Также он способен помочь составить рацион питания на неделю и уведомлять вас каждый раз как наступает время приема пищи.").await?;
